        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    DeclineReason = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: true),
                    AttemptCount = table.Column<int>(type: "integer", nullable: false),
                    ScheduledRetryAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreviouslyRecoveredPayments = table.Column<int>(type: "integer", nullable: false),
                    RecentDeclines = table.Column<int>(type: "integer", nullable: false),
                    RecentAttempts = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecoveryAnalyses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RecoveryAnalyses_Payments_PaymentId",
                        column: x => x.PaymentId,
                        principalTable: "Payments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_ScheduledRetryAt",
                table: "Payments",
                column: "ScheduledRetryAt");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecoveryAnalyses_ExecutedAt",
                table: "RecoveryAnalyses",
                column: "ExecutedAt");

            migrationBuilder.CreateIndex(
                name: "IX_RecoveryAnalyses_PaymentId",
                table: "RecoveryAnalyses",
                column: "PaymentId",
                unique: true);
